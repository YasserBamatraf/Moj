...
<head>
    ...
    <title> دليل المواطنين | وزارة العدل - عدن</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="allservice.html"><i class="fas fa-book ml-2"></i> دليل المواطنين</a>
                    </li>
            ...
            <div class="row justify-content-center mb-5">
                <div class="col-md-6">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="ابحث عن الخدمة..." aria-label="ابحث عن الخدمة">
                        <button class="btn" type="button" style="background-color: #ffc300; color: #01315d;">
