...
<body>
    ...
    <section class="services-section py-5 bg-white">
        <div class="container">
            <h2 class="text-center mb-5">المحاكم الإدارية</h2>
            <div class="row">
                <!-- محكمة 1 -->
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <img src="https://i.imgur.com/court1.jpg" class="card-img-top" alt="المحكمة الإدارية عدن" style="height: 250px; object-fit: cover;">
                        <div class="card-body" style="background-color: #f8f9fa;">
                            <h5 class="card-title" style="color: #01315d;"><i class="fas fa-balance-scale me-2"></i>المحكمة الإدارية عدن</h5>
                            <p class="card-text">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <img src="https://i.imgur.com/court2.jpg" class="card-img-top" alt="المحكمة الإدارية حضرموت" style="height: 250px; object-fit: cover;">
                        <div class="card-body" style="background-color: #f8f9fa;">
                            <h5 class="card-title" style="color: #01315d;"><i class="fas fa-balance-scale me-2"></i>المحكمة الإدارية حضرموت</h5>
                            <p class="card-text">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <img src="https://i.imgur.com/court3.jpg" class="card-img-top" alt="المحكمة الإدارية المهرة" style="height: 250px; object-fit: cover;">
                        <div class="card-body" style="background-color: #f8f9fa;">
                            <h5 class="card-title" style="color: #01315d;"><i class="fas fa-balance-scale me-2"></i>المحكمة الإدارية المهرة</h5>
                            <p class="card-text">
