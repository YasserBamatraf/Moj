...
<body>
    ...
    <section class="services-section py-5 bg-white">
        <div class="container">
            <h2 class="text-center mb-5">الشكاوي الإلكترونية</h2>
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <form>
                        ...
                        <div class="mb-3">
                            <label for="complaint-type" class="form-label">نوع الشكوى</label>
                            <select class="form-select" id="complaint-type" required>
                                <option value="">اختر نوع الشكوى</option>
                                <option value="1">شكوى إدارية</option>
                                <option value="2">شكوى قضائية</option>
                                <option value="3">شكوى خدمات</option>
                                <option value="4">أخرى</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label for="complaint-details" class="form-label">تفاصيل الشكوى</label>
                            <textarea class="form-control" id="complaint-details" rows="5" required></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary px-5">إرسال الشكوى</button>
                        </div>
                    </form>
                </div>
            </div>
