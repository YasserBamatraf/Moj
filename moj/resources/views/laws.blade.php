...
<head>
    ...
    <title>نصوص | البحث في القوانين</title>
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"></li>
                        <a class="nav-link active" href="laws.html"><i class="fas fa-book-open ml-2"></i> القوانين والتشريعات </a>
                    </li> 
                    <li class="nav-item">
        ...
        <div class="container">
            <div class="row align-items-center mb-5">
                <div class="col-12 text-center">
                    <img src="images/nsoos-icon.png" alt="شعار خدمة نصوص" class="img-fluid mb-4" style="max-width: 200px;">
                    <h2 class="display-4 mb-3">خدمة نصوص</h2>
                    <div class="lineH2 mx-auto"></div>
                    <p class="lead mt-3">البحث في النصوص القانونية والتشريعات</p>
                </div>
            </div>
        </div>
        <div class="container">
            ...
            <div class="search-section mb-5">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="ابحث عن القوانين والتشريعات..." aria-label="Search laws">
            ...
            <div class="laws-grid">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">قانون السلطة القضائية</h5>
                                <p class="card-text">تاريخ النشر: 15 يناير 2024</p>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">قانون الإجراءات الجزائية</h5>
                                <p class="card-text">تاريخ النشر: 10 يناير 2024</p>
                                <a href="#" class="btn btn-custom">
                                    <i class="fas fa-file-pdf"></i> تحميل PDF
                                </a>
                            </div>
