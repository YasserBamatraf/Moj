...
<head>
    ...
    <title>عن وزير العدل | وزارة العدل - العاصمة عدن</title>
    ...
    <nav class="navbar navbar-expand-lg main-menu">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="index.html"><i class="fas fa-home ml-2"></i> الرئيسية</a>
                    </li>
                    <li class="nav-item dropdown ">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item active" href="AboutMinister.html"><i class="fas fa-user-tie ml-2"></i> عن الوزير</a></li>
    ...
    <section class="services-section py-5 bg-white">
        <div class="container">
            ...
            <div class="text-center mb-5">
                <img src="minister.jpg" alt="وزير العدل" class="img-fluid rounded-circle mb-4" style="width: 300px; height: 300px; object-fit: cover;">
                <h2 class="display-4 fw-bold" style="color: #0a4275;">القاضي / بدر العارضة</h2>
                <h4 class="text-muted">وزير العدل في العاصمة عدن</h4>
            </div>

            <!-- السيرة الذاتية -->
            <div class="card mb-5">
                <div class="card-body p-5">
                    <h3 class="card-title mb-4" style="color: #0a4275;">السيرة الذاتية</h3>
                    <p class="card-text">
                        نص السيرة الذاتية للوزير يوضع هنا... يتضمن معلومات عن خبراته ومؤهلاته وإنجازاته في المجال القضائي والقانوني.
                    </p>
                    <a href="cv.pdf" class="btn btn-warning" download>
            ...
            <div class="timeline">
                ...
                <div class="row g-0">
                    <div class="col-md-6">
                        <div class="card m-3" style="background-color: #0a4275; color: white;">
                            <div class="card-body">
                                <h4 class="card-title">الدراسة</h4>
                                <ul class="list-unstyled">
                                    <li class="mb-2">بكالوريوس في القانون - جامعة عدن</li>
                                    <li class="mb-2">ماجستير في القانون الدولي</li>
                                    <li>دكتوراه في القانون الدستوري</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card m-3" style="background-color: #ffc107;">
                            <div class="card-body">
                                <h4 class="card-title">المناصب</h4>
                                <ul class="list-unstyled">
                                    <li class="mb-2">وزير العدل - 2023 حتى الآن</li>
                                    <li class="mb-2">رئيس محكمة الاستئناف - 2020-2023</li>
                                    <li>قاضي المحكمة العليا - 2015-2020</li>
                                </ul>
                            </div>
                        </div>
                    </div>
