...
<body>
    ...
    <section class="services-section py-5 bg-white">
        <div class="container">
            <img src="images/omna-icon.png" alt="أيقونة البحث عن أمناء شرعيين" class="d-block mx-auto mb-4" style="width: 100px;">
            <h2 class="text-center mb-5">البحث عن أمناء شرعيين</h2>
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <div class="search-box mb-4">
                        <form class="d-flex">
                            <input type="text" class="form-control" placeholder="ادخل اسم الأمين الشرعي">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>12346</td>
                                    <td>صنعاء</td>
                                    <td><span class="badge bg-warning">قيد التجديد</span></td>
                                    <td>2024/06/30</td>
                                </tr>
                            </tbody>
                        </table>
