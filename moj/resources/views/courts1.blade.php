...
<head>
    ...
    <title> المحاكم الإبتدائية</title>
...
<body>
    ...
    <section class="services-section py-5 bg-white">
        <div class="container">
            <h2 class="text-center mb-5">المحاكم الإبتدائية</h2>
            <div class="row">
                <!-- محكمة 1 -->
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <img src="https://i.imgur.com/court1.jpg" class="card-img-top" alt="محكمة المنصورة" style="height: 250px; object-fit: cover;">
                        <div class="card-body" style="background-color: #f8f9fa;">
                            <h5 class="card-title" style="color: #01315d;"><i class="fas fa-balance-scale me-2"></i>محكمة المنصورة الإبتدائية</h5>
                            <p class="card-text">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <img src="https://i.imgur.com/court2.jpg" class="card-img-top" alt="محكمة الشيخ عثمان" style="height: 250px; object-fit: cover;">
                        <div class="card-body" style="background-color: #f8f9fa;">
                            <h5 class="card-title" style="color: #01315d;"><i class="fas fa-balance-scale me-2"></i>محكمة الشيخ عثمان الإبتدائية</h5>
                            <p class="card-text">
                                <i class="fas fa-map-marker-alt me-2" style="color: #ffc300;"></i>المحافظة: عدن<br>
                                <i class="fas fa-location-arrow me-2" style="color: #ffc300;"></i>المديرية: الشيخ عثمان<br>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <img src="https://i.imgur.com/court3.jpg" class="card-img-top" alt="محكمة كريتر" style="height: 250px; object-fit: cover;">
                        <div class="card-body" style="background-color: #f8f9fa;">
                            <h5 class="card-title" style="color: #01315d;"><i class="fas fa-balance-scale me-2"></i>محكمة كريتر الإبتدائية</h5>
                            <p class="card-text">
                                <i class="fas fa-map-marker-alt me-2" style="color: #ffc300;"></i>المحافظة: عدن<br>
                                <i class="fas fa-location-arrow me-2" style="color: #ffc300;"></i>المديرية: كريتر<br>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <img src="https://i.imgur.com/court4.jpg" class="card-img-top" alt="محكمة التواهي" style="height: 250px; object-fit: cover;">
                        <div class="card-body" style="background-color: #f8f9fa;">
                            <h5 class="card-title" style="color: #01315d;"><i class="fas fa-balance-scale me-2"></i>محكمة التواهي الإبتدائية</h5>
                            <p class="card-text">
                                <i class="fas fa-map-marker-alt me-2" style="color: #ffc300;"></i>المحافظة: عدن<br>
                                <i class="fas fa-location-arrow me-2" style="color: #ffc300;"></i>المديرية: التواهي<br>
                                <i class="fas fa-phone me-2" style="color: #ffc300;"></i>الجوال: 777456789
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <img src="https://i.imgur.com/court5.jpg" class="card-img-top" alt="محكمة المعلا" style="height: 250px; object-fit: cover;">
                        <div class="card-body" style="background-color: #f8f9fa;">
                            <h5 class="card-title" style="color: #01315d;"><i class="fas fa-balance-scale me-2"></i>محكمة المعلا الإبتدائية</h5>
                            <p class="card-text">
                                <i class="fas fa-map-marker-alt me-2" style="color: #ffc300;"></i>المحافظة: عدن<br>
                                <i class="fas fa-location-arrow me-2" style="color: #ffc300;"></i>المديرية: المعلا<br>
                                <i class="fas fa-phone me-2" style="color: #ffc300;"></i>الجوال: 777567890
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <img src="https://i.imgur.com/court6.jpg" class="card-img-top" alt="محكمة دار سعد" style="height: 250px; object-fit: cover;">
                        <div class="card-body" style="background-color: #f8f9fa;">
                            <h5 class="card-title" style="color: #01315d;"><i class="fas fa-balance-scale me-2"></i>محكمة دار سعد الإبتدائية</h5>
                            <p class="card-text">
                                <i class="fas fa-map-marker-alt me-2" style="color: #ffc300;"></i>المحافظة: عدن<br>
                                <i class="fas fa-location-arrow me-2" style="color: #ffc300;"></i>المديرية: دار سعد<br>
                                <i class="fas fa-phone me-2" style="color: #ffc300;"></i>الجوال: 777678901
                            </p>
                        </div>
                    </div>
                </div>
